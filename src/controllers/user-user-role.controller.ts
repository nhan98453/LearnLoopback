...
export class UserUserRoleController {
  ...
  async find(
    ...
    return this.userRepository.user_role_list(id).find(filter);
  }
  ...
  async create(
    ...
    return this.userRepository.user_role_list(id).create(userRole);
  }
  ...
  async patch(
    ...
    return this.userRepository.user_role_list(id).patch(userRole, where);
  }
  ...
  async delete(
    ...
    return this.userRepository.user_role_list(id).delete(where);
  }
}
